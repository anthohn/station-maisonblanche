            ...
            <div className="container mx-auto px-6 max-w-7xl">
                ...
                >
                    <div className="absolute inset-0">
                        <Image src="/shop.jpg" alt="Intérieur du shop épicerie Station Maison-Blanche à Chancy, Genève" fill className="object-cover transition-transform duration-700 group-hover:scale-105" priority />
                    </div>
                ...
                >
                    ...
                    <motion.div variants={itemVariants} className="bg-white rounded-[2rem] shadow-sm border border-slate-100 md:col-span-2 md:row-span-2 flex flex-col overflow-hidden group">
                        <div className="relative h-[55%] w-full overflow-hidden shrink-0">
                            <Image src="/IMG_6698.JPEG" alt="Fleurs et plantes de saison en vente à la Station Maison-Blanche, Chancy" fill className="object-cover object-center transition-transform duration-700 group-hover:scale-105" />
                        </div>
