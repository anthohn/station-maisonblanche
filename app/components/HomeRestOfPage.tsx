        ...
        <div className="bg-slate-50 pb-24">
            ...
            <section className="container mx-auto px-6 max-w-7xl pt-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    >
                        <Image src="/devanture.jpeg" alt="Devanture du shop épicerie Station-Service Maison-Blanche à Chancy, Genève" fill className="object-cover transition-transform duration-700 group-hover:scale-105" sizes="(max-width: 768px) 100vw, 33vw" />
                    ...
                    >
                        <Image src="/pompes0.jpg" alt="Pompes à carburant Shell V-Power et diesel, Station-Service Maison-Blanche Chancy" fill className="object-cover transition-transform duration-700 group-hover:scale-105" sizes="(max-width: 768px) 100vw, 33vw" />
                        <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-black/10" />
                    ...
                    <motion.div
                        ...
                        className="relative h-[380px] rounded-[2rem] overflow-hidden group shadow-sm text-white"
                    >
                        <Image src="/lavage.jpeg" alt="Pistes de lavage haute pression en libre-service, Station-Service Maison-Blanche Chancy" fill className="object-cover transition-transform duration-700 group-hover:scale-105" sizes="(max-width: 768px) 100vw, 33vw" />
                        <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-black/10" />
