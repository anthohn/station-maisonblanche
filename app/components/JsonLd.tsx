export default function JsonLd() {
    const gasStationSchema = {
        ...
        description:
            "Station service Shell à Chancy, Genève. Carburants Shell V-Power et diesel 24h/24, épicerie de proximité ouverte 7j/7 de 06h00 à 21h00, lavage haute pression en libre-service et aspirateurs industriels. Même propriétaire que le Garage Maison Blanche attenant.",
        priceRange: "€€",
