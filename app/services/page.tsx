...
export const metadata: Metadata = {
    ...
    description:
        "Découvrez tous les services de la Station Maison-Blanche à Chancy (Genève) : carburants Shell V-Power et diesel disponibles 24h/24 et 7j/7, épicerie de proximité ouverte tous les jours, lavage haute pression en libre-service, borne de gonflage pneus et vente de gaz Vitogaz.",
    keywords: [
        ...
        "Station Maison Blanche services",
    ],
    openGraph: {
        title: "Nos Services | Station Maison-Blanche — Chancy, Genève",
        description:
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "Pompes à essence Shell à la Station Maison-Blanche, Chancy",
            },
        ],
    },
    twitter: {
