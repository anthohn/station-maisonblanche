...
export async function GET() {
    try {
        ...
        const vcardLines = [
            ...
            'X-SOCIALPROFILE;type=facebook:https://www.facebook.com/profile.php?id=61580606409294',
            'X-SOCIALPROFILE;type=instagram;x-user=station_maisonblanche:https://www.instagram.com/station_maisonblanche',
            'URL;TYPE=Facebook:https://www.facebook.com/profile.php?id=61580606409294',
            'URL;TYPE=Instagram:https://www.instagram.com/station_maisonblanche',
